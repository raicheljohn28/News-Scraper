...
// var MONGODB_URI = process.env.MONGODB_URI || "mongodb://127.0.0.1/news-scraper";
...
app.post("/articles/:id", function (req, res) {
    ...
    db.Comment.create(req.body).then(function (dbComment) {
        return db.Article.findOneAndUpdate({ _id: req.params.id }, { $push: { comments: dbComment }}, {new: true }).then(function (dbRes) {
            res.redirect("/");
        });
    })
